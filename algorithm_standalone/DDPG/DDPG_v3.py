...
class DDPG(object):
    ...
    def _build_a(self, s, reuse=None, custom_getter=None):
        ...
        with tf.variable_scope('Actor', reuse=reuse, custom_getter=custom_getter):
            s = tf.layers.dense(s, 400, activation=tf.nn.relu, name='l1', trainable=trainable)
            s = tf.layers.dense(s, 300, activation=tf.nn.relu, name='l2', trainable=trainable)
            a = tf.layers.dense(s, self.a_dim, activation=tf.nn.tanh, name='a', trainable=trainable)
    ...
    def _build_c(self, s, a, reuse=None, custom_getter=None):
        ...
        with tf.variable_scope('Critic', reuse=reuse, custom_getter=custom_getter):
            x = tf.layers.dense(tf.concat([s, a], axis=-1), 400, activation=tf.nn.relu, name='c1', trainable=trainable)
            x = tf.layers.dense(x, 300, activation=tf.nn.relu, name='c2', trainable=trainable)
