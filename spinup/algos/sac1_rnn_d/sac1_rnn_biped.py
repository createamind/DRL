...
def sac1_rnn(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
         ...
         polyak=0.995, lr=5e-4, alpha=0.2, batch_size=128, start_steps=10000,
...
if __name__ == '__main__':
    ...
    sac1_rnn(lambda n: Wrapper1(gym.make(args.env),action_repeat=n), # lambda:Wrapper(gym.make(args.env)), #
         actor_critic=core.rnn_actor_critic,
         batch_size=args.batch_size,
         ac_kwargs=dict(hidden_sizes=[400,300], h_size=args.state, seq=args.seq, h0=args.h0),
         gamma=args.gamma,
         seed=args.seed,
         epochs=args.epochs,
         alpha=args.alpha,
