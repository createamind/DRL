...
######
    ...
    def test_agent(n=5):  # n: number of tests
        ...
        for j in range(n):
            ...
            # o, r, d, ep_ret, ep_len = test_env.step(1)[0], 0, False, 0, 0  #####################
    ...
    EPSILON_DECAY = 0.999975  ## 0.9975 99975
    MIN_EPSILON = 0.001
    ...
    for t in range(total_steps):
        ...
        if d or (ep_len == max_ep_len):   # make sure: max_ep_len < steps_per_epoch
            ...
            #if d:
            logger.store(EpRet=ep_ret, EpLen=ep_len, Epsilon=epsilon)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='BeamRider-ramNoFrameskip-v4')  # CartPole-v0(o4a2, alpha2, gamma0.8), LunarLander-v2(o8a4, alpha:0.05-0.2), Acrobot-v1, Breakout-ram-v4(alpha0.8, gamma0.99)), MountainCar-v0 Atlantis-ram-v0
    ...
    parser.add_argument('--exp_name', type=str, default=f'dqn_repeat_{parser.parse_args().action_repeat}_env_{parser.parse_args().env}'
                                                        f'_alpha_{parser.parse_args().alpha}_target_{parser.parse_args().target}'
                                                        f'_norm_{parser.parse_args().norm}_0.999975')
    args = parser.parse_args()
    # print("88888888\n"*22, args.norm)
    from spinup.utils.run_utils import setup_logger_kwargs
    logger_kwargs = setup_logger_kwargs(args.exp_name, args.seed)

    # env_breakout = gym.make(parser.parse_args().env)
