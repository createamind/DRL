...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='Acrobot-v1')  # CartPole-v0 Acrobot-v1 LunarLander-v2
    ...
    parser.add_argument('--exp_name', type=str, default='sac1n_1000_Acrobot-v1_0.2entropy')
    ...
    sqn(lambda : gym.make(args.env), actor_critic=core.mlp_actor_critic,
        ...
        gamma=args.gamma, seed=args.seed, epochs=args.epochs, alpha=args.alpha, lr=args.lr,
