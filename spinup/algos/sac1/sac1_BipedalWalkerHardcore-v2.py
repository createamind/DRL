...
######
    if alpha == 'auto':
        ...
        alpha_optimizer = tf.train.AdamOptimizer(learning_rate=lr*1, name='alpha_optimizer')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='sac1_baseline_BipedalWalkerHardcore-v2_alpha_auto_h0_1')
