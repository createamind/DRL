...
######
    ...
    for t in range(total_steps):
        ...
        if d or (ep_len == max_ep_len_train):
            ...
            if t > start_steps and (ep_ret<300 or np.random.random()<1.1):
                for ep_i in ep_buff:
                    replay_buffer.store(*ep_i)
            ep_buff = []
...
if __name__ == '__main__':
    ...
    sac1(lambda n: Wrapper(gym.make(args.env),action_repeat=n), actor_critic=core.mlp_actor_critic,
